    ...
    <div>
      <Layout>
        ...
        <div>
          ...
          <p>
            If you are a web developer then you have used many css selector to
            give styling to your web page. In this blog we are going to explore
            some rare but usefull selector of css
          </p>
        </div>
        ...
        <div>
          ...
          <div>
            ...
            <p>
              Where + select next first sibling but ~ select all next sibling
              after tag.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Select all element that is last element of its parent(opposite of
              first-of-type)
            </p>
          </div>
